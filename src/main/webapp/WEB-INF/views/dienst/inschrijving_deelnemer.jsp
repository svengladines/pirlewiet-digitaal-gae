...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<div>
		...
		<div>
			<form:form class="form form-form" method="post" action="${pageContext.request.contextPath}/inschrijvingen/${inschrijving.id}/deelnemer" modelAttribute="command">
