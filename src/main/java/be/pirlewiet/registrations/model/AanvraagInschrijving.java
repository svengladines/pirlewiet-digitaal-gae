...
@Entity
public class AanvraagInschrijving implements Serializable {
...
//	@IndexColumn(name="deelnemers_col")
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AanvraagInschrijving)) {
            return false;
        }
        AanvraagInschrijving castOther = (AanvraagInschrijving) other;
