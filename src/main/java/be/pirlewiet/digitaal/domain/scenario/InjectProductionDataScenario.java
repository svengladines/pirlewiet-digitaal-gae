	...
	public void execute( String... parameters ) {
		...
		// Voorjaar 2026
		{
			...
			if ( holiday == null ) {
				...
				start.setTime( Timing.moment( "06/04/2026 08:00" ) );
				GregorianCalendar end = new GregorianCalendar();
				end.setTime( Timing.moment( "11/04/2026 23:00" ) );
		...
		}
		{
			...
			if ( holiday == null ) {
				...
				holiday = new Holiday();
				GregorianCalendar start = new GregorianCalendar();
				start.setTime( Timing.moment( "11/04/2026 08:00" ) );
				
				GregorianCalendar end = new GregorianCalendar();
				end.setTime( Timing.moment( "18/04/2026 23:00" ) );
				holiday.setName( name );
		...
		}
		{
			...
			if ( holiday == null ) {
				holiday = new Holiday();
				GregorianCalendar start = new GregorianCalendar();
				start.setTime( Timing.moment( "18/05/2026 08:00" ) );
				GregorianCalendar end = new GregorianCalendar();
				end.setTime( Timing.moment( "22/05/2026 23:00" ) );
				holiday.setName( name );
				holiday.setPeriod( Period.Spring );
		...
		// Zomer 2026
				// VOV 2
				{
					...
					if ( holiday == null ) {
						...
						start.setTime( Timing.moment( "04/07/2026 08:00" ) );
						
						GregorianCalendar end
							= new GregorianCalendar();
						
						end.setTime( Timing.moment( "11/07/2026 23:00" ) );
				...
				// KIKA
				{
					...
					if ( holiday == null ) {
						...
						start.setTime( Timing.moment( "20/07/2026 08:00" ) );
						
						GregorianCalendar end
							= new GregorianCalendar();
						
						end.setTime( Timing.moment( "27/07/2026 23:00" ) );
				...
				// Tika
				{
					...
					if ( holiday == null ) {
						...
						start.setTime( Timing.moment( "03/08/2026 08:00" ) );
						
						GregorianCalendar end
							= new GregorianCalendar();
						
						end.setTime( Timing.moment( "09/08/2026 23:00" ) );
				...
				// Gezins 1
				{
					...
					if ( holiday == null ) {
						...
						start.setTime( Timing.moment( "30/07/2026 08:00" ) );
						
						GregorianCalendar end
							= new GregorianCalendar();
						
						end.setTime( Timing.moment( "05/08/2026 23:00" ) );
				...
				// Gezins 2
				{
					...
					if ( holiday == null ) {
						...
						start.setTime( Timing.moment( "06/08/2026 08:00" ) );
						
						GregorianCalendar end
							= new GregorianCalendar();
						
						end.setTime( Timing.moment( "12/08/2026 23:00" ) );
					...
					
				{
					...
					if ( holiday == null ) {
						holiday = new Holiday();
						GregorianCalendar start= new GregorianCalendar();
						start.setTime( Timing.moment( "08/07/2026 08:00" ) );
						GregorianCalendar end= new GregorianCalendar();
						
						end.setTime( Timing.moment( "12/07/2026 23:00" ) );
