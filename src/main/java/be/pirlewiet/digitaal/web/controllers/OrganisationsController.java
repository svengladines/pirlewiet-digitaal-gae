...
public class OrganisationsController {
	...
	@ResponseBody
	public ResponseEntity<Organisation> post( @RequestBody Organisation organisation,  HttpServletResponse response ) {
		...
		case "city": 
				return new Comparator<Organisation>() {
					...
					public int compare(Organisation o1, Organisation o2) {
						Address a1 = o1.getAdres();
						Address a2 = o2.getAdres();
